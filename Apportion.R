...
apor <- apportion(Site=dat.cln$SWSN_Site,Type=dat.cln$Type,ct=dat.cln$Count,beg.date=800,end.date=1300,interval=25,site.beg=dat.cln$BegAge,
               site.end=dat.cln$EndAge,type.beg=dat.cln$BegType,type.end=dat.cln$EndType)